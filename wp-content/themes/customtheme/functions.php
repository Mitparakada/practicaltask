...
add_action('init', function() {
	register_post_type('portfolio-cpt', [
	...
	register_taxonomy('project_categories', ['portfolio-cpt'], [
		'label' => __('Project Categories', 'txtdomain'),
		'hierarchical' => true,
		'rewrite' => ['slug' => 'project_category'],
		'show_admin_column' => true,
		'show_in_rest' => true,
		'labels' => [
			'singular_name' => __('Project Categories', 'txtdomain'),
